...
export interface CreateFetchInstance<TParams extends AnyObject, TData extends AnyObject> {
  ...
  getState: (params: TParams, queryClient: QueryClient) => QueryState<TData, undefined>;
  useFetch: (
    params: TParams,
